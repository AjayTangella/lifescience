...
file_path1=f"abfss://bronze@ajayinsurance.dfs.core.windows.net/hosa/transactions/{date}"
file_path2=f"abfss://bronze@ajayinsurance.dfs.core.windows.net/hosb/transactions/{date}"
read_type="parquet"
