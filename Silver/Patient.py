...
file_path1=f"abfss://bronze@ajayinsurance.dfs.core.windows.net/hosa/patients/{date}"
file_path2=f"abfss://bronze@ajayinsurance.dfs.core.windows.net/hosb/patients/{date}"
read_type="parquet"
